...
**1. What BMI ranges are considered underweight, normal, overweight, and obese according to the CDC? What are the health risks associated with obesity?**

Your answer:

---

**2. What is the difference between Urban and Rural healthcare access? How might Residence_type affect stroke outcomes (think about hospital proximity, emergency response times)?**

Your answer:

---

**3. How does smoking affect stroke risk? What is the difference in risk between current smokers, former smokers, and never smokers?**

Your answer:

---

**4. What is the connection between heart disease and stroke? Why do these conditions often occur together?**
...
### Version B: Decade-Based Categories

Use these categories based on decade of life (common in epidemiological studies):

| Age Group | Range | Clinical Rationale |
|-----------|-------|-------------------|
| 0-9 | 0-9 | Childhood, stroke extremely rare |
| 10-19 | 10-19 | Adolescence |
| 20-29 | 20-29 | Young adulthood |
| 30-39 | 30-39 | Early career years |
| 40-49 | 40-49 | Middle age begins |
| 50-59 | 50-59 | Risk factors accumulate |
| 60-69 | 60-69 | Elevated risk |
| 70-79 | 70-79 | High risk |
| 80+ | 80+ | Highest risk population |
...
**1. How many patients are in each decade of life?**

Your answer:

---

**2. What is the stroke rate (percentage) for each decade?**

Your answer:

---

**3. In which decade does the stroke rate first exceed 5%? In which decade does it first exceed 10%? What does this tell you about when stroke prevention should begin?**
...
1. **A question about BMI and stroke:**


---

2. **A question comparing Urban vs. Rural patients:**


---

3. **A question about smoking status and age:**
...
Write one question about **diet, exercise, or lifestyle habits** that this dataset cannot answer, and explain why.
...
**"What is the stroke rate for each combination of Residence_type (Urban/Rural) and gender?"**
...
Which combination has the highest stroke rate? Which has the lowest? Are there any surprising patterns?
...
- [ ] **Part 4:** Created `age_group` column using the **Decade-Based Categories**
- [ ] **Part 4:** Calculated stroke rate by age group with interpretation
- [ ] **Part 5:** Three research questions (BMI, Urban/Rural, smoking+age)
- [ ] **Part 5:** One unanswerable question about diet/exercise/lifestyle
- [ ] **Part 5:** Residence_type × gender groupby analysis
...
- **Rural vs Urban Health Disparities:** https://www.cdc.gov/ruralhealth/about.html
- **Smoking and Stroke Risk:** https://www.stroke.org/en/about-stroke/stroke-risk-factors/smoking-and-stroke-risk
